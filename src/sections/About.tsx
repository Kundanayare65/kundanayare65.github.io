      ...
      <div className="grid gap-8 lg:grid-cols-[.78fr_1.22fr] lg:items-center">
        <Reveal>
          ...
          <div className="mt-4 max-w-[420px] space-y-2.5 text-[11px] leading-[1.65] text-slate-600">
            <p>I'm a Computer Science graduate and Associate Test Engineer at EY GDS with hands-on experience in cloud-native DevOps and applied machine learning.</p>
            <p>I enjoy building self-service developer platforms, GitOps delivery pipelines, observability stacks, and data-driven solutions with Kubernetes, Terraform, Rust, and Python.</p>
          </div>
          ...
          <div id="contact" className="relative overflow-hidden rounded-2xl border border-indigo-100 bg-gradient-to-br from-purple-100 via-white to-indigo-50 px-7 py-7 shadow-[0_12px_40px_rgba(99,102,241,.08)]">
            ...
            <div className="relative">
              ...
              <div className="mt-5 flex flex-wrap gap-2.5">
                <a href="mailto:kundanayare65@gmail.com" className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-white/80 px-4 py-2.5 text-[10px] font-medium transition hover:border-indigo-200 hover:text-indigo-500"><Mail size={13} /> Email Me</a>
                <a href="https://linkedin.com/in/kundan-ayare-77a024212/" className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-white/80 px-4 py-2.5 text-[10px] font-medium transition hover:border-indigo-200 hover:text-indigo-500"><Linkedin size={13} /> LinkedIn</a>
                <a href="https://github.com/Kundanayare65" className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-white/80 px-4 py-2.5 text-[10px] font-medium transition hover:border-indigo-200 hover:text-indigo-500"><Github size={13} /> GitHub</a>
              </div>
            </div>
          </div>
        </Reveal>
